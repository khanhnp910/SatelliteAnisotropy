...
def plot_general(elvis_isolated_dir, caterpillar_dir, brightest_dir_template, X_type='D_sph', Y_type='D_rms', is_surv_probs=True, save_dir=None, saveimage=False, figsize=(5,5)):
  if save_dir is None:
    saveimage=False
